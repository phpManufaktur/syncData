...
define('sync_error_rmdir',											'<p>Das Verzeichnis <b>%s</b> konnte nicht gelösht werden!</p>');
...
define('sync_error_sync_missing_keys',					'<p>Die Antwort des syncData Server ist unvollständig, es sind nicht alle erwarteten Schlüssel enthalten!</p>');
...
define('sync_msg_no_backup_files_in_dir',				'<p>Im Verzeichnis <b>%s</b> wurden keine Backups gefunden, die für eine Rücksicherung verwendet werden können.</p><p></p>Übertragen Sie die Archivdateien, die verwendet werden sollen, per FTP in das Verzeichnis <b>%s</b> und rufen Sie diesen Dialog anschließend wieder auf.</p>');
...
define('sync_msg_update_running',								'<p>Die Aktualisierung wird ausgeführt.</p><p>Schliessen Sie dieses Fenster nicht und <b>warten Sie die Statusmeldung durch syncData  nach max. %s Sekundenab</b>.</p>');
